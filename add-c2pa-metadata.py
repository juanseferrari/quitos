#!/usr/bin/env python3
"""
Script to copy C2PA metadata chunks from tronoArg.png to other PNG files
to make them iOS Safari 17+ compatible
"""
...
def main():
    ...
    # Target files to add C2PA metadata to
    target_files = [
        "src/styles/assets/images/rey.png",
        "src/styles/assets/images/del.png", 
        "src/styles/assets/images/truco.png"
    ]
