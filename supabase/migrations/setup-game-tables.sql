-- Setup Game Data Tables for Rey del Truco
-- Execute this SQL in your Supabase SQL Editor

-- 1. Games table to store completed games
...
-- 2. Game moves table to store individual scoring events
...
-- 7. RLS Policies for data_migrations
...
-- 10. Optional: Create a view for game statistics
...
-- Success message
SELECT 'Tables created successfully! Ready for data migration.' as status;